...
// Public Marketplace (restaurant directory - no auth required)
...
// Stripe Webhook (internal route, called by api.r3sto.ch)
app.use('/api/stripe', stripeWebhookRoutes)

// Marketing routes (menu du jour, campaigns)
...
app.get('/api', (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      public: {
        restaurants: 'GET /api/public/restaurants?q=&region=&cuisine=',
        restaurantDetail: 'GET /api/public/restaurants/:slug'
      }
    }
  })
})
