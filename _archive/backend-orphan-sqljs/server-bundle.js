// ════════════════════════════════════════════════════════════════════════════
//  R3STO Backend - Bundled Server (All code inlined)
//  Version: 1.0.0
// ════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════
//  AUTH MIDDLEWARE (from middleware/auth.js) - inlined
// ════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════
//  LOGGING MIDDLEWARE (from middleware/logging.js) - inlined
// ════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════
//  ERROR HANDLER (from middleware/errorHandler.js) - inlined
// ════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════
//  ROUTES: Health (from routes/health.js) - inlined
// ════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════
//  ROUTES: Auth (from routes/auth.js) - inlined
// ════════════════════════════════════════════════════════════════════════════
...
authRouter.get('/me', verifyTokenMiddleware, (req, res) => {
  try {
...
authRouter.post('/logout', verifyTokenMiddleware, (req, res) => {
  res.json({ message: 'Logged out successfully' })
})

authRouter.post('/refresh', verifyTokenMiddleware, (req, res) => {
  try {
...
// ════════════════════════════════════════════════════════════════════════════
//  ROUTES: Reservations (from routes/resas.js) - inlined
// ════════════════════════════════════════════════════════════════════════════

const resasRouter = Router()

resasRouter.get('/', verifyTokenMiddleware, (req, res) => {
  try {
...
resasRouter.get('/:id', verifyTokenMiddleware, (req, res) => {
  try {
    const resa = row(
...
resasRouter.post('/', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const {
...
resasRouter.patch('/:id', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
resasRouter.delete('/:id', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const result = run(
...
resasRouter.post('/:id/status', verifyTokenMiddleware, (req, res) => {
  try {
...
resasRouter.post('/swap', verifyTokenMiddleware, (req, res) => {
  try {
...
resasRouter.get('/search', verifyTokenMiddleware, (req, res) => {
  try {
    const { q } = req.query
    const restaurantId = req.user.restaurantId
...
// ════════════════════════════════════════════════════════════════════════════
//  ROUTES: Tables (from routes/tables.js) - inlined
// ════════════════════════════════════════════════════════════════════════════

const tablesRouter = Router()

tablesRouter.get('/', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
tablesRouter.get('/:id', verifyTokenMiddleware, (req, res) => {
  try {
    const table = row(
...
tablesRouter.post('/', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const {
...
tablesRouter.patch('/:id', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
tablesRouter.delete('/:id', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const result = run(
...
tablesRouter.put('/batch', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
tablesRouter.post('/:id/block', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
tablesRouter.post('/:id/unblock', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
tablesRouter.post('/:id/hold', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const now = Date.now()
...
tablesRouter.post('/:id/release', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const now = Date.now()
...
// ════════════════════════════════════════════════════════════════════════════
//  ROUTES: Clients (from routes/clients.js) - inlined
// ════════════════════════════════════════════════════════════════════════════

const clientsRouter = Router()

clientsRouter.get('/', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
clientsRouter.get('/:id', verifyTokenMiddleware, (req, res) => {
  try {
    const client = row(
...
clientsRouter.post('/', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const {
...
clientsRouter.patch('/:id', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
clientsRouter.delete('/:id', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const result = run(
...
clientsRouter.get('/search', verifyTokenMiddleware, (req, res) => {
  try {
    const { q } = req.query
    const restaurantId = req.user.restaurantId
...
clientsRouter.post('/:id/blacklist', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const { reason } = req.body
...
clientsRouter.post('/:id/unblacklist', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
clientsRouter.get('/:id/stats', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const clientId = req.params.id
...
// ════════════════════════════════════════════════════════════════════════════
//  ROUTES: Config (from routes/config.js) - inlined
// ════════════════════════════════════════════════════════════════════════════

const configRouter = Router()

configRouter.get('/resto', verifyTokenMiddleware, (req, res) => {
  try {
...
configRouter.patch('/resto', verifyTokenMiddleware, requireRole('proprietaire'), (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const updates = req.body
...
configRouter.get('/options', verifyTokenMiddleware, (req, res) => {
  try {
...
configRouter.patch('/options', verifyTokenMiddleware, requireRole('proprietaire', 'manager'), (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const updates = req.body
...
configRouter.get('/services', verifyTokenMiddleware, (req, res) => {
  try {
    const services = rows(
...
configRouter.post('/services', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
configRouter.put('/services', verifyTokenMiddleware, requireRole('proprietaire'), (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
configRouter.get('/salles', verifyTokenMiddleware, (req, res) => {
  try {
    const salles = rows(
...
configRouter.put('/salles', verifyTokenMiddleware, requireRole('proprietaire'), (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
configRouter.get('/users', verifyTokenMiddleware, requireRole('proprietaire', 'manager'), (req, res) => {
  try {
    const users = rows(
...
configRouter.put('/users', verifyTokenMiddleware, requireRole('proprietaire'), (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
// ════════════════════════════════════════════════════════════════════════════
//  ROUTES: Widget (from routes/widget.js) - inlined
// ════════════════════════════════════════════════════════════════════════════

const widgetRouter = Router()

widgetRouter.get('/:slug/config', extractUserMiddleware, (req, res) => {
  try {
...
widgetRouter.get('/:slug/availability', extractUserMiddleware, (req, res) => {
  try {
    const { slug } = req.params
...
widgetRouter.post('/:slug/book', extractUserMiddleware, (req, res) => {
  try {
    const { slug } = req.params
...
widgetRouter.post('/validate-email', (req, res) => {
  try {
...
widgetRouter.post('/cancel', (req, res) => {
  try {
...
// ════════════════════════════════════════════════════════════════════════════
//  ROUTES: Payments (from routes/payments.js) - inlined
// ════════════════════════════════════════════════════════════════════════════

const paymentsRouter = Router()

paymentsRouter.post('/create-intent', extractUserMiddleware, (req, res) => {
  try {
...
paymentsRouter.get('/bill/:table', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
paymentsRouter.post('/:id/split', verifyTokenMiddleware, (req, res) => {
  try {
...
paymentsRouter.post('/:id/confirm', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
paymentsRouter.get('/:id/status', extractUserMiddleware, (req, res) => {
  try {
    const intentId = req.params.id
...
paymentsRouter.post('/:id/refund', verifyTokenMiddleware, (req, res) => {
  try {
...
paymentsRouter.post('/create-checkout-session', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const { plan } = req.body
...
paymentsRouter.post('/create-portal-session', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
// ════════════════════════════════════════════════════════════════════════════
//  ROUTES: Orders (from routes/orders.js) - inlined
// ════════════════════════════════════════════════════════════════════════════

const ordersRouter = Router()

ordersRouter.get('/', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
ordersRouter.get('/:id', verifyTokenMiddleware, (req, res) => {
  try {
    const order = row(
...
ordersRouter.post('/:id/advance', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
ordersRouter.patch('/:id', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const orderId = req.params.id
...
ordersRouter.delete('/:id', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
    const result = run(
...
// ════════════════════════════════════════════════════════════════════════════
//  ROUTES: Sync (from routes/sync.js) - inlined
// ════════════════════════════════════════════════════════════════════════════

const syncRouter = Router()

syncRouter.get('/state', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
syncRouter.post('/push', verifyTokenMiddleware, (req, res) => {
  try {
...
syncRouter.get('/events', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
...
syncRouter.get('/reservations', verifyTokenMiddleware, (req, res) => {
  try {
    const restaurantId = req.user.restaurantId
